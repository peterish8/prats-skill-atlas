...
name: optimise-Codex
description: >
  Use this skill when the goal is to minimize Codex token usage,
  ...
  Triggers on: "optimize tokens", "reduce usage", "save credits", "Codex limit",
  "token efficiency", "long conversation", "agent cost reduction".
---

# Codex Token Optimizer Skill

**Description:**  
Use this skill to minimize Codex token usage, avoid hitting limits, and maximize efficiency during long or complex sessions.
...
## Goal
Maximize efficiency and avoid hitting Codex usage limits.# Codex Token Optimizer
