...
description: Summarizes the entire current conversation into a structured, copy-paste context block for starting a new Codex chat with full continuity. Use when the user runs /summarize-context or asks to "summarize context", "make a context block", or "summarize for new chat".
user-invocable: true
---
