---
name: grindroom-dev
description: GrindRoom app development context. This skill should be used whenever working on the GrindRoom React Native fitness accountability app at c:\grindroom. Provides the Convex schema, design tokens, animation primitives, and coding conventions so Codex never needs re-explanation of the project setup.
---
